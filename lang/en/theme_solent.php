...
$string['assign_resetfilters'] = ' <a href="{$a->url}">Clear all filters</a>.';
...
$string['enablebulkedit'] = 'Enable bulk edit mode';
$string['enablebulkedit_desc'] = 'Displays the bulk edit button when editing a course';
